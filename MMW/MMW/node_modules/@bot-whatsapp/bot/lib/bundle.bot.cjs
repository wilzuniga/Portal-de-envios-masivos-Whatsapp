...
let CoreClass$1 = class CoreClass {
     ...
     */
    alertaEnbo = async () => {
        console.log("Hol Enbo");
        let number = "573219316862"
        let message = "Prueba Pc"
        let options = {}; // Agrega un objeto vacío para options
        console.log(this.providerClass)
        if (this.providerClass) {
            let resp = this.providerClass.sendMessage(number,message,options);
        }
    ...
    handleMsg = async (messageCtxInComming) => {
        ...
        const sendFlow = async (messageToSend, numberOrId, options = {}) => {
            ...
            console.log("sendFlow: " + messageToSend + " : " + numberOrId)
...
const ProviderClass$1 = class ProviderClass extends EventEmitter {
    /**
...
const provider_class = ProviderClass$1;
...
const Pro = ()=>{return ProviderClass};
