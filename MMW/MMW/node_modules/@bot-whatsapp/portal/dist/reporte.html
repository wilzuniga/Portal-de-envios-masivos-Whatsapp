        ...
        <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu"
          ...
          <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link d-flex align-items-center gap-2 active" href="/reporte">
                  <svg class="bi">
...
document.getElementById('btnDescargar').addEventListener('click', function() {
  ...
  .then(data => {
    ...
    $.each(data, function (index, item) {
      console.log(item)
        var fila = "<tr><td>" + item.nombre + "</td><td>" + item.numero + "</td><td>" + item.mensaje + "</td><td>" + item.Estado + "</td><td>" + item.descripcionEstado + "</td></tr>";
        $("#tablaDatos tbody").append(fila);
      });
      $('#tablaDatos').DataTable();
    // Aquí puedes procesar los datos como desees, por ejemplo, mostrándolos en la interfaz de usuario.
  })
    .catch(error => {
      console.log(error);
    });
