        ...
        <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu"
          ...
          <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link d-flex align-items-center gap-2 active" href="/panel">
                  <svg class="bi">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h1 class="modal-title fs-5" id="importModalLabel">Importar Números</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body">
                <div class="mb-3">
                  <!-- <label for="recipient-name" class="col-form-label">Descargar Plantilla:</label> -->
                  <!-- <button ></button> -->
                  <input type="button" class="form-control btn btn-primary"  value="Descargar Plantilla" id="btnDescargar">
                </div>
                <div class="mb-3">
...
document.getElementById('btnDescargar').addEventListener('click', function() {
    ...
    var rutaArchivo = 'Plantilla_MMW.xlsx'; // Reemplaza con tu ruta y nombre de archivo
