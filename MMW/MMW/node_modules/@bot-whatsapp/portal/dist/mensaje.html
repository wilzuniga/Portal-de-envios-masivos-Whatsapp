...
<body>
        ...
        <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu"
          ...
          <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link d-flex align-items-center gap-2 active" href="/mensaje">
                  <svg class="bi">
              ...
              <li class="nav-item">
                <a class="nav-link d-flex align-items-center gap-2" href="/send-mensaje">
                  <svg class="bi">
                    <use xlink:href="#send" />
                  </svg>
                  Enviar Mensaje
  ...
  Launch demo modal
        ...
        <h2 class="text-center">Configura el Mensaje</h2>
        <div class="container">
          <form id="miFormulario" action="/guardar-mensaje" method="post" enctype="multipart/form-data">
            <div class="mb-3">
                <label for="exampleFormControlTextarea1" class="form-label">Mensaje a Enviar:</label>
                <textarea class="form-control" id="exampleFormControlTextarea1" name="mensaje" rows="3"></textarea>
                <p>Puedes agregar @nombre en tu mensaje así se verá reflejado con el nombre de tu contacto</p>
            </div>
            <div class="mb-3">
                <label for="formFileDisabled" class="form-label">Adjunta un Archivo al Mensaje</label>
